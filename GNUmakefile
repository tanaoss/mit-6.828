...
QEMUOPTS += -netdev user,id=hn0,hostfwd=tcp::$(PORT7)-:7,hostfwd=udp::$(PORT80)-:80 \
hostfwd=udp::$(PORT7)-:7 -device e1000,id=e0,netdev=hn0 -object filter-dump,id=d1,netdev=hn0,file=qemu.pcap
